      ...
      <div className="container mx-auto max-w-5xl text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            ...
            <div className="bg-card p-8 rounded-lg shadow-xs">
                ...
                <form className="space-y-6" action="https://formspree.io/f/mzzalznb" method="POST">
                    <div>
                    ...
                    <div>
                        <label htmlFor="name" className="block text-sm font-medium mb-2"> Sua mensagem! </label>
                        <textarea 
                        id="message" 
                        name="message" 
                        required 
